import sys
sys.path.append('/home/ivms/local_disk/allrank')
...
def parse_args() -> Namespace:
    ...
    parser.add_argument("--job-dir", default="./output_transoformer_0001", help="Base output path for all experiments")
    parser.add_argument("--run-id", default="test", help="Name of this run to be recorded (must be unique within output dir)")
    parser.add_argument("--config-file-name", default="/home/ivms/local_disk/allrank/reproducibility_sku/configs/contextaware_web30k/ordinal.json", type=str, help="Name of json file with config")
