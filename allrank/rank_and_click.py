...
def parse_args() -> Namespace:
    ...
    parser.add_argument("--job-dir", default="./output", help="Base output path for all experiments")
    parser.add_argument("--run-id", default="click_test", help="Name of this run to be recorded (must be unique within output dir)")
    parser.add_argument("--config-file-name", default="local_config_click_model.json", type=str, help="Name of json file with model config")
